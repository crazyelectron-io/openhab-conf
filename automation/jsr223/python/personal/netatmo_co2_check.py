...
def netatmoCO2Check(event):
    ...
    if currentCO2level > CO2ThresholdHi:
        ...
        if isinstance(ir.getItem("CO2HighReported_Livingroom"), UnDefType) or items["CO2HighReported_Livingroom"] == OFF:
    ...
    #--- Check if CO2 level below low threshold
        ...
        if CO2HiReportedToday and (isinstance(ir.getItem("CO2HighReported_Livingroom"), UnDefType) or items["CO2LowReported_Livingroom"] == OFF):
