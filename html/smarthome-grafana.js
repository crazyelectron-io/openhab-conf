...
var
    SMARTHOME_GRAFANA_DEFAULTS = {
        ...
        panelPath: "/d-solo/db/",
        renderPanelPath: "/render/d-solo/db/",
...
function GrafanaPanel(params) {
    ...
    function updateFrameSourceURL() {
        ...
        if (render === "true") {
            ...
            url += "&fullscreen&cacheBuster=" + Date.now();
        }
        ...
        for (var key in vars) {
            if (vars[key].itemName !== undefined && vars[key].itemName === itemName) {
                if (vars[key].itemFunction) {
                    ...
                    console.log("Update value for item = " + itemName);
                }
                vars[key].value = value;
            }
            else {
                console.log("Update value failed for item = " + itemName);
            }
        }
    }
    ...
    function assertVarsDefinedOrSubscribeToESH(vars) {
        for (var key in vars) {
            ...
            if (itemName !== undefined) {
                ...
                console.log("Subscribing to Item update for Item = " + itemName);
