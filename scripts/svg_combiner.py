...
symbol_count = 0
mypath = '/opt/oh2/openhab2/conf/html/matrix-theme/original-svgs'
...
for file in onlyfiles:
	if(file[:1] != '.'):
		...
		r = requests.get('http://192.168.2.2:5080/static/matrix-theme/original-svgs/' + file)
		print r.status_code
		if(len(r.text)>0):
...
f = open('/opt/oh2/openhab2/conf/html/matrix-theme/squidink.svg', 'w')
